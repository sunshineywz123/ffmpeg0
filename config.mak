...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-programs --disable-yasm
prefix=/usr/local
...
DST_PATH=/home/ywz/sambafiles/ffmpeg-2.8.15
...
EXTRALIBS=-lXv -lX11 -lXext -lva -lva-x11 -lva -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lsndio -lasound -lSDL -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
